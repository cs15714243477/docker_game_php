...
{
    return new Response(200, ['Content-Type' => 'application/json', 'Server' => 'byq'], json_encode($data, $options));
}
...
function view($template, $vars = [], $app = null)
{
    ...
    return new Response(200, ['Server' => 'byq'], $handler::render($template, $vars, $app));
}
